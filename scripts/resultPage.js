...
const questions = () => {
  ...
  arrayOfQuestions.forEach((question, index) => {
    ...
    question.incorrect_answers.forEach((incorrectAnswer) => {
      ...
      if (incorrectAnswer === arrayOfAnswers[index]) {
        li.classList.add("userSelectPieno");
      } else {
        li.classList.add("userSelectVuoto");
      }
    ...
    if (
      arrayOfAnswers.includes(question.correct_answer) ||
      arrayOfAnswers.includes(question.incorrect_answer)
    ) {
      correctLi.classList.add("userSelectPieno");
    } else {
      correctLi.classList.add("userSelectVuoto");
    }
    ...
    if (arrayOfAnswers.includes(question.correct_answer)) {
